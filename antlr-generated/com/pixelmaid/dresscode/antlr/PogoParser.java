// $ANTLR 3.5 /Users/Katie/Documents/Java/workspace/DressCode_v0.5/src/com/pixelmaid/dresscode/antlr/Pogo.g 2013-05-16 15:40:46
...
public class PogoParser extends Parser {
	...
	public final PogoParser.forStatement_return forStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: block, Identifier, expression, For, expression
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final PogoParser.repeatStatement_return repeatStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: Identifier, expression, expression, Repeat, block
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
